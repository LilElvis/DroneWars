Shader "Stephen/Toon/ToonXOutlineDouble" 
{
	Properties 
	{
		...
		_Outline1 ("2nd Outline Width", Range (.002, 0.03)) = .005
	...
	SubShader 
	{
		...
		UsePass "Stephen/Toon/ToonSecondOutline/OUTLINE"
		UsePass "Stephen/Toon/ToonFirstOutline/OUTLINE"
	}
